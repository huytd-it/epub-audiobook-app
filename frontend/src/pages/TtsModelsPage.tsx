...
import { TtsModel } from "@/pages/book-detail/types";
...
export function TtsModelsPage() {
  ...
  return <div className="space-y-5">
    <header className="space-y-2">
      ...
      <p className="max-w-3xl text-sm text-muted-foreground">Kiểm tra weights cục bộ, tải hoặc làm mới các model được app quản lý. Nên dừng các job đang dùng model trước khi cập nhật.</p>
    </header>
