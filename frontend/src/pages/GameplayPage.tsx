...
type Game = { id: string; name: string; family: "pixel" | "neon" | "legacy"; waveform_policy: string; description: string; enabled: boolean };
...
const fallbackCatalog: Game[] = [
  { id: "garden_cycle", name: "Garden Cycle", family: "pixel", waveform_policy: "allowed_with_safe_area", description: "Trồng và thu hoạch một khu vườn yên bình.", enabled: true },
  { id: "aquarium_ecosystem", name: "Aquarium Ecosystem", family: "pixel", waveform_policy: "default_off", description: "Đàn cá và cây thủy sinh chuyển động chậm.", enabled: true },
  { id: "parcel_route", name: "Parcel Route", family: "pixel", waveform_policy: "allowed_with_safe_area", description: "Chuyến giao hàng yên bình qua thị trấn.", enabled: true },
  { id: "cloud_runner", name: "Cloud Runner", family: "pixel", waveform_policy: "allowed_with_safe_area", description: "Chuyến chạy ngắm cảnh qua mây và đồng cỏ.", enabled: true },
  { id: "orbit_drift", name: "Orbit Drift", family: "neon", waveform_policy: "default_off", description: "Trôi qua các cổng sáng trong không gian.", enabled: true },
  { id: "marble_flow", name: "Marble Flow", family: "neon", waveform_policy: "forbidden", description: "Những viên bi sáng đi qua mạng đường mềm.", enabled: true },
  { id: "territory_bloom", name: "Territory Bloom", family: "neon", waveform_policy: "default_off", description: "Các dải màu nở và hòa vào nhau.", enabled: true },
  { id: "signal_garden", name: "Signal Garden", family: "neon", waveform_policy: "default_off", description: "Mạng nút ánh sáng đồng bộ theo nhịp chậm.", enabled: true },
